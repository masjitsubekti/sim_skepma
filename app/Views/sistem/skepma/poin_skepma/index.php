    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header" style="background-color:#0a85da !important; padding:0.75rem 1.25rem;">
                <span style="color:#ffffff; font-size:12pt;"><i class="fa fa-bars"></i><b> Poin Skepma</b></span>
            </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                foreach ($data_skepma->getResult() as $row) { $no++ ?>
                                    <tr>
                                        ...
                                        <td style="width:50%;"><b><?= $row->nama_kelompok_kegiatan; ?></b> (<i><?= $row->keterangan; ?></i>)</td>
