    ...
    <div class="card bg-analytics text-white">
      <div class="card-content">
        <div class="card-body text-center">
          <img src="<?php echo base_url() ?>/themes/app-assets/images/elements/decore-left.png" class="img-left"
            alt="card-img-left">
          <img src="<?php echo base_url() ?>/themes/app-assets/images/elements/decore-right.png" class="img-right"
            alt="card-img-right">
          ...
          <div class="text-center">
            <?php $nama_user = strtolower(session()->get('auth_nama_user'));?>
            <h4 class="mb-2 text-white">Selamat Datang <?= ucwords($nama_user) ?></h4>
            <p class="m-auto">Aplikasi SKEPMA ini merupakan alat bantu dan media pencatatan kegiatan mahasiswa.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-lg-3 col-md-6 col-12">
    <div class="card" style="height:225px;">
      <div class="card-header d-flex flex-column pt-3">
        ...
        <p class="mb-0">Kegiatan Terverifikasi</p>
      </div>
