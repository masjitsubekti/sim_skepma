    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header" style="background-color:#0a85da !important; padding:0.75rem 1.25rem;">
                <span style="color:#ffffff; font-size:12pt;"><i class="fa fa-bars"></i><b> Daftar Mahasiswa</b></span>
            </div>
            <div class="card-content">
                <div class="card-body">
                    <div class="row" style="padding-top:12px;">
                        <div class="col-md-2">
                            <select class="form-control" onchange="pageLoad(1)" name="limit" id="limit">
...
<!-- DATA SORT -->
<input type="hidden" name="input_id_th" id="input_id_th" value="#column_nama_mhs">
<input type="hidden" name="input_column" id="input_column" value="mhsnama">
...
<script>
    ...
    function pageLoad(i) {
        ...
        var cari = $('#cari').val();
        $.ajax({
            url: "<?php echo site_url('dosen/read-data-mhs/') ?>" + i,
            type: 'post',
            dataType: 'html',
            data: {
                limit: limit,
