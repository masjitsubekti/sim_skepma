    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header" style="background-color:#7E74FC !important; padding:0.75rem 1.25rem;">
                <span style="color:#ffffff;"><i class="fa fa-bars"></i><b> Role Permission</b></span>
            </div>
...
<script>
    ...
    function pageLoad(i) {
        ...
        var cari = $('#cari').val();
        $.ajax({
            url: "<?php echo site_url('menu-user/read-data/') ?>" + i,
            type: 'post',
            dataType: 'html',
            data: {
                limit: limit,
    ...
    $("#btn-add").click(function() {
        $.ajax({
            url: "<?php echo site_url('menu-user/load-modal') ?>",
            type: 'post',
            dataType: 'html',
            beforeSend: function() {},
            success: function(result) {
