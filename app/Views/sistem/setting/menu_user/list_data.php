    ...
    <table class="table table-bordered table-hover">
        <thead class="tr-head">
            <tr>
                ...
                <th width="10%" class="sortable text-center" id="column_level" data-sort="" onclick="sort_table('#column_level','level')">Level Menu</th>
                <th width="10%" class="sortable text-center" id="column_urutan" data-sort="" onclick="sort_table('#column_urutan','urutan')">Urutan</th>
            ...
            foreach ($list->getResult() as $row) { $no++ ?>
                <tr>
                    ...
                    <td class="text-center">
                        <a href="javascript:;" data-id="<?=$row->id_menu_user?>" data-name="<?=$row->nama_menu?>" class="btn btn-sm btn-icon btn-danger waves-effect waves-light btn-hapus" data-toggle="tooltip" title="Hapus Menu User"><i class="fa fa-trash"></i></a>	    
                    </td>
                </tr>
            <?php } ?>
        </tbody>
