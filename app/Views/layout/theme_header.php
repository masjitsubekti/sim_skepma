          ...
          <li class="dropdown dropdown-user nav-item">
            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
              <div class="user-nav d-sm-flex d-none"><span
                  class="user-name text-bold-600"><?= session()->get('auth_nama_user') ?></span><span
                  class="user-status"><?= session()->get('auth_nama_role') ?></span></div><span><img class="round"
                  src="<?= base_url('all/images/icon/user.png') ?>" alt="avatar" height="40" width="40"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
              <a class="dropdown-item" href="<?= site_url('setting/profile') ?>"><i class="feather icon-user"></i> Profile &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</a>
              <div class="dropdown-divider"></div><a class="dropdown-item" href="javascript:;" onclick="logout()"><i
